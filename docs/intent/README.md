...
- **[Exemples et recettes](examples.md)** — variantes BGP/OSPF/MPLS/LAN  
- **[FAQ](faq.md)** — questions fréquentes  

Pour la **CLI**, les chemins du dépôt et les flux (`generate`, `diff`, `push`, `sync-startup`), voir **[`docs/README.md`](../README.md)**.
